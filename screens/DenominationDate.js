...
export class DenominationDate extends Component {
	constructor(props) {
		super(props);
	...
	fetchData = () => {
		...
		this.setState({
			...
			fetch(
				ser_url +
					'/denominationDate.php?company_no=' +
					loginDetails.ID +
					'&from_date=' +
									...
									<TouchableOpacity 
										...
										navigate('DenomList', {
											...
											<View style={{width:'90%'}}>
												...
												<Text style={styles.prod}>
													<Text style={styles.prodName}>Pending Amount : </Text>
													<Text style={styles.prodMrp}>{item.Pending}</Text>
												</Text>
												<Text style={styles.prod}>
...
export default connect(mapStateToProps, {})(DenominationDate);
