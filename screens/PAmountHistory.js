...
export class PendingHistory extends Component {
	constructor(props) {
		super(props);
	...
	componentDidMount() {
		let originalSel ='';
		let originalTo ='';
		if(this.props.route.params.pAmount_date == undefined){
			originalSel = this.props.route.params.selDate;
			originalTo = this.props.route.params.toDate;
		} else {
			originalSel = this.props.route.params.pAmount_date;
			originalTo = this.props.route.params.pAmount_date;
		}
		this.setState(
			{
			...
			<View style={styles.container}>
				...
				{productList.length == 0 ? (
					...
					<FlatList
								...
								<View style={{flexDirection:'row'}}>
										...
										<View style={{width:'90%'}}>
											<View style={{flexDirection: 'row', alignItems: 'center'}}>
												...
												<Text style={styles.prodMrp}>{item.reason}</Text>
											</View>
											<View style={{flexDirection: 'row', alignItems: 'center'}}>
						...
						keyExtractor={(item, index) => 'pendingHistory' + index}
					/>
				)}
				</View>
...
export default connect(mapStateToProps, {addProductList})(PendingHistory);
