...
export class LoanAmountDate extends Component {
	constructor(props) {
		super(props);
	...
	fetchData = () => {
		...
		this.setState({
			...
			.then(json => {
				// console.log(json);
				if (json.LaonAmount_List.length > 0) {
					this.setState({
						productList: json.LaonAmount_List,
					});
				} else {
					this.setState({
						productList: [],
									...
									<TouchableOpacity 
										...
										navigate('LoanAmountHistory', {
											...
											<View style={{width:'90%'}}>
												...
												<Text style={styles.prod}>
													<Text style={styles.prodName}>Total Credit Amount : </Text>
													<Text style={styles.prodMrp}>{item.TotalAmountCredit}</Text>
												</Text>
												<Text style={styles.prod}>
													<Text style={styles.prodName}>Total Debit Amount : </Text>
													<Text style={styles.prodMrp}>{item.TotalAmountDebit}</Text>
												</Text>
...
export default connect(mapStateToProps, {})(LoanAmountDate);
